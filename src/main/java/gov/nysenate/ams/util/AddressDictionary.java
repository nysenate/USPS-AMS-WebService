...
public class AddressDictionary {
    ...
    public static final Map<String,String> abbrMap = new HashMap<>();
    ...
    static {
        ...
        abbrMap.put("DC","District of Columbia");
        abbrMap.put("FM","Federated States of Micronesia");
        ...
        abbrMap.put("MH","Marshall Islands");
        ...
        abbrMap.put("MP","Northern Mariana Islands");
        abbrMap.put("OH","Ohio");
        abbrMap.put("OK","Oklahoma");
        abbrMap.put("OR","Oregon");
        abbrMap.put("PW","Palau");
        abbrMap.put("PA","Pennsylvania");
        abbrMap.put("PR","Puerto Rico");
