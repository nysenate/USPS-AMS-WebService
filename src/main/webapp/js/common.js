...
amsCommon.factory('dataBus', function($rootScope) {
    var dataBus = {
...
amsCommon.factory('menuService', function(dataBus) {
    var menuService = {
        methodIndex : '',
...
amsCommon.controller('MenuController', function($scope, menuService, dataBus){
    $scope.index = 1;
